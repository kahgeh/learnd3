...
function mapPropsToDimension(props: SliderProps) {
    const { range, size, position } = props;
...
const slider: React.FunctionComponent<SliderProps> = (props) => {
    ...
    const { area, handleRadius, slideGuideLine, middleLine, scale } = dimensions;
    ...
    return (<svg width={area.width} height={area.height} ref={svgBoxRef} >
